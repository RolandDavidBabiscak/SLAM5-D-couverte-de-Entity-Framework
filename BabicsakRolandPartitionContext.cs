...
public partial class BabicsakRolandPartitionContext : DbContext
{
    public BabicsakRolandPartitionContext()
    {
    }

    public BabicsakRolandPartitionContext(DbContextOptions<BabicsakRolandPartitionContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=192.168.10.16;port=3306;user=babicsak_roland;password=kMUX2wRf;database=babicsak_roland_Partition", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.4.1-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Partition>(entity =>
        {
            ...
            entity.HasOne(d => d.NumstyleNavigation).WithMany(p => p.InverseNumstyleNavigation)
